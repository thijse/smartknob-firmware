...
class PhysicalComponentTester:
    ...
    def setup_raw_logging(self):
        ...
        # Write logs to smartknob-connection2/logs/test_physical_working_with_raw_logging/<timestamped>.log
        project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        log_dir = os.path.join(project_root, 'logs', 'test_physical_working_with_raw_logging')
